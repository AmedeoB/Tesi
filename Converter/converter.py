# This is a copy of the constrained.py file from
# https://github.com/dwavesystems/dimod/blob/0.12.12/dimod/constrained/constrained.py#L2054
...
def cqm_to_bqm(cqm: ConstrainedQuadraticModel, lagrange_multiplier: Optional[Bias] = None,
    ...
    bqm = BinaryQuadraticModel(Vartype.BINARY)
    # Create a dictionary for binary variables
    binary: Dict[Variable, Vartype] = {}
    # Create a dictionary for integer variables
    ...
    for v in cqm.variables:
        ...
        # If binary or similar, insert in binary dictionary
        if vartype is Vartype.SPIN or vartype is Vartype.BINARY:
            binary[v] = vartype
        # If integer
    ...
    if lagrange_multiplier is None:
        ...
        # If no constraints or vars no need of lag mult
        else:
            lagrange_multiplier = 0  # doesn't matter

    # For every constraint, convert it based on structure
